...
public class Cochera extends Estacionamiento{
	...
	public Cochera(Cochera cochera) {
		this.facilidades = cochera.copiarCaracteristicas();
		this.condicion = cochera.getCondicion();
		this.automovil = null;
		if(cochera.getAutomovil()!=null) {
			this.automovil = new Automovil(cochera.getAutomovil());
		}
	}
	
	public ArrayList<Caracteristica> copiarCaracteristicas() {
		ArrayList<Caracteristica> arrAux = new  ArrayList<Caracteristica>();
		for (Caracteristica caracteristica : facilidades) {
