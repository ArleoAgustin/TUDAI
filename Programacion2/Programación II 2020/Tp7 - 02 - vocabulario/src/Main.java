...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Las palabras en orden alfabetico son: "+et.getWordsinAsendingOrder(5));
		System.out.println("Obtener palabras en orden por frecuencia: "+et.getWordsInFrequencyOrder(5));
	}
