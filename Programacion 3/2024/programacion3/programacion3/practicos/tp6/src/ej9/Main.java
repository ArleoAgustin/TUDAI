...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Celda c5 = new Celda(false,true,true,true,13,1,0);

        Celda c6 = new Celda(true,true,true,true,21,1,1);

        Celda c7 = new Celda(true,true,true,true,24,1,2);

        Celda c8 = new Celda(true,false,true,true,12,1,3);

        Celda c9 = new Celda(false,true,true,true,34,2,0);

        Celda c10 = new Celda(true,true,true,true,13,2,1);

        Celda c11 = new Celda(true,true,true,true,33,2,2);

        Celda c12 = new Celda(true,false,true,true,100,2,3);

        Celda c13 = new Celda(false,true,false,true,45,3,0);

        Celda c14 = new Celda(true,true,false,true,64,3,1);

        Celda c15 = new Celda(true,true,false,true,70,3,2);

        Celda c16 = new Celda(true,false,false,true,86,3,3);
        ...
        System.out.println(ej9.buscarSolucion(c1,c12));
    }
}
